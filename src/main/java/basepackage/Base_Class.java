...
public class Base_Class {
	...
	public static void initialzation()
	{
		...
		{
			System.setProperty("webdriver.chrome.driver", "C:\\Others\\Workspace\\Admin_Panel\\Admin_panel\\browser_driver\\chromedriver.exe");
			driver = new ChromeDriver();
			
		}else if(browser.equals("FF"))
			{
				System.setProperty("webdriver.gecko.driver", "C:\\Users\\User1\\.m2\\repository\\org\\seleniumhq\\selenium\\selenium-firefox-driver\\3.141.59\\selenium-firefox-driver-3.141.59.jar");
